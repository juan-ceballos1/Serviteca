...
public class Vehiculo {
    ...
    private static final String LA_CLAVE_DEBE_TENER_UNA_LONGITUD_MAYOR_O_IGUAL_A = "La matricula debe tener una longitud mayor o igual a 4";
    ...
    public Vehiculo(Long id,String matricula,String marca, String modelo){
        ...
        validarLongitud(matricula,LONGITUD_MINIMA_MATRICULA,LA_CLAVE_DEBE_TENER_UNA_LONGITUD_MAYOR_O_IGUAL_A);
